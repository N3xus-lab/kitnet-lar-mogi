(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function r(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(e){if(e.ep)return;e.ep=!0;const o=r(e);fetch(e.href,o)}})();(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const e of a)if(e.type==="childList")for(const o of e.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(a){const e={};return a.integrity&&(e.integrity=a.integrity),a.referrerPolicy&&(e.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?e.credentials="include":a.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function r(a){if(a.ep)return;a.ep=!0;const e=t(a);fetch(a.href,e)}})();(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const e of a)if(e.type==="childList")for(const o of e.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function t(a){const e={};return a.integrity&&(e.integrity=a.integrity),a.referrerPolicy&&(e.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?e.credentials="include":a.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function r(a){if(a.ep)return;a.ep=!0;const e=t(a);fetch(a.href,e)}})();function n(){return`
    ...
    <section class="unidades section" id="unidades">
      <div class="container">
        ...
        <div class="unidades__grid">
          ${[{nome:"Gratidão",descricao:"Kitnet aconchegante, ideal para quem busca praticidade e conforto.",imagem:"/images/unidades/gratidao.jpg",disponivel:!1},{nome:"Sabedoria",descricao:"Ambiente bem distribuído com cozinha americana e ótima iluminação.",imagem:"/images/unidades/sabedoria.jpg",disponivel:!0},{nome:"Esperança",descricao:"Perfeita para casais, com espaço otimizado e decoração clean.",imagem:"/images/unidades/esperanca.jpg",disponivel:!0},{nome:"Felicidade",descricao:"Ampla e arejada, com área de serviço privativa.",imagem:"/images/unidades/felicidade.jpg",disponivel:!1},{nome:"Harmonia",descricao:"A melhor vista da região, com quarto separado e sala integrada.",imagem:"/images/unidades/harmonia.jpg",disponivel:!0}].map(i=>`
            <article class="unidade-card ${i.disponivel?"":"unidade-card--indisponivel"}">
              <div class="unidade-card__image-wrapper">
                <img src="${i.imagem}" alt="Kitnet ${i.nome} - Kitnet Lar Mogi" class="unidade-card__image" loading="lazy" />
                ${i.disponivel?"":'<span class="unidade-card__badge">Em breve</span>'}
              </div>
              <div class="unidade-card__content">
                <h3 class="unidade-card__nome">${i.nome}</h3>
                <p class="unidade-card__descricao">${i.descricao}</p>
                <a href="https://wa.me/5511998526680?text=Ol%C3%A1!%20Vim%20pelo%20site%20e%20tenho%20interesse%20na%20unidade%20${i.nome}!" target="_blank" rel="noopener noreferrer" class="btn btn--primary unidade-card__btn">
                  Consulte Valores
                </a>
              </div>
            </article>
  ...
  `}function m(){return`
    <section class="galeria section" id="galeria">
      ...
      <div class="galeria__grid">
        ${["/images/galeria/foto-01.jpg","/images/galeria/foto-02.jpg","/images/galeria/foto-03.jpg","/images/galeria/foto-04.jpg","/images/galeria/foto-05.jpg","/images/galeria/foto-06.jpg","/images/galeria/foto-07.jpg","/images/galeria/foto-08.jpg"].map((i,t)=>`
          <div class="galeria__item">
            <img src="${i}" alt="Kitnet Lar Mogi - Foto ${t+1}" class="galeria__image" loading="lazy" />
          </div>
        `).join("")}
      </div>
    </section>
    ...
    <section class="diferenciais section" id="diferenciais">
      <div class="container">
        ...
        <div class="diferenciais__grid">
          ${["Água inclusa","Internet banda larga","Segurança 24h","Ambiente familiar","Excelente custo-benefício","Próximo ao transporte público","Mercado a 200m","Farmácia a 300m","Entrada facilitada","Sem fiador"].map(i=>`
    ...
    <section class="depoimentos section" id="depoimentos">
      <div class="container">
        ...
        <div class="depoimentos__grid">
          ${[{nome:"Maria Silva",texto:"Kitnet organizada, segura e muito bem localizada. O atendimento foi excelente!",estrelas:5},{nome:"João Santos",texto:"Me mudei rápido e sem burocracia. Internet boa e ambiente familiar como prometido.",estrelas:5},{nome:"Ana Oliveira",texto:"A melhor kitnet de Mogi! Perto de tudo e o custo-benefício é imbatível.",estrelas:5}].map(i=>`
            <div class="depoimento-card">
              <div class="depoimento-card__estrelas">${"★".repeat(i.estrelas)}</div>
              <p class="depoimento-card__texto">"${i.texto}"</p>
              <span class="depoimento-card__nome">${i.nome}</span>
            </div>
          `).join("")}
        </div>
      </div>
